...
const ProductCard = ({ addToCart, product, collection }) => {
  return (
    <>
      {product && (
        <div className="w-full max-w-sm shadow-xl bg-white border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700">
          <Link
      ...
      {collection && (
        <div className="w-full max-w-sm shadow-xl bg-white border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700">
          <Link
            to={`collection-details/${collection.name}`}
            className="flex items-center justify-center"
          >
            <img
              className="p-2 rounded-t-lg w-full h-full object-cover"
