...
const CollectionDetailsResult = ({ Collections, addToCart, result }) => {
  return (
    <div className="flex justify-between items-center max-lg:flex-col gap-10 w-full">
      <div className="flex-1 flex justify-center items-center w-full h-full bg-slate-100 rounded-lg">
        <img
          src={result.cover}
          alt="product detail"
          width={380}
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex items-center gap-2 mt-4">
          ...
          <div className="h-5 w-1 bg-slate-200" />
...
export default CollectionDetailsResult;
